...
public class BloggerController {
	...
	public static Logger logger=Logger.getLogger(BloggerController.class);
	...
	@ResponseBody
	public String autoLogin(@CookieValue(value="username",required=false) String userName,
